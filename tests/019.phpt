--TEST--
Throwing exceptions in error handler and returning objects
--SKIPIF--
<?php include 'skipif.inc'; ?>
--FILE--
<?php
function error_handler_exception($err) { throw new Exception($err); }
function error_handler_object($err) { $r = new stdClass(); $r->err = $err; return $r; }
